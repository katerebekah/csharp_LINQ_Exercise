...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(c => c.Birthday)    /*FILL IN LINQ EXPRESSION*/; //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var minValue = PracticeData[2].Students.Min(c => c.Birthday)/*FILL IN LINQ EXPRESSION*/; //HINT: Cohort3 is PracticeData[2]
